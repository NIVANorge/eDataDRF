...
Checks that criterion IDs and titles are within the expected sets,
scores are integers between 0 and 4, and required/recommended
classification is valid.

## Usage

``` r
pb_validate_CREED_data_relevance(data, actions = action_levels(), agent = TRUE)
```
...
- data:
  ...
  Data frame containing CREED relevance data to validate
...
for the reliability equivalent,
[`example_CREED_relevance_tibble()`](https://NIVANorge.github.io/eDataDRF/reference/example_CREED_relevance_tibble.md)
for an example CREED relevance table.
